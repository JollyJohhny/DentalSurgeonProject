...
namespace DentalSurgeryProject
{
    public partial class Form5 : Form
    {
        ...
        private void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            {
                string d =DateTime.Now.Year.ToString() + "-" +DateTime.Now.Month.ToString() + "-" + DateTime.Now.AddDays(1).Day.ToString();
                string View_Query = "SELECT * FROM dbo.Appointment WHERE AppointmentType = '" + cmbAtype.Text + "' AND AppointmentDate = '"+d+"'";
